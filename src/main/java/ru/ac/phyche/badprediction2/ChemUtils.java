...
public class ChemUtils {
	...
	public static enum FingerprintsType {
		...
		CIRCULAR_4_512, ECFP_6_4096_ADDITIVE, ECFP_6_8192_ADDITIVE, ECFP_6_1024_ADDITIVE;
	}
	...
	public static float[] fingerprints(String smiles, FingerprintsType type) throws CDKException {
		...
		if (type == FingerprintsType.ECFP_6_8192_ADDITIVE) {
			return (circularAdditiveFingerPrints(mol, CircularFingerprinter.CLASS_ECFP6, 8192, false));
		}
		if (type == FingerprintsType.ECFP_6_4096_ADDITIVE) {
			return (circularAdditiveFingerPrints(mol, CircularFingerprinter.CLASS_ECFP6, 4096, false));
		}
		if (type == FingerprintsType.ECFP_6_1024_ADDITIVE) {
	...
	public static String atomContainerlToSmiles(IAtomContainer mol, boolean stereochemistry) throws CDKException {
		Aromaticity arom = new Aromaticity(ElectronDonation.cdk(), Cycles.cdkAromaticSet());
		AtomContainerManipulator.percieveAtomTypesAndConfigureAtoms(mol);
